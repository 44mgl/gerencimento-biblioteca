...
<html lang="pt-br">
	...
	<body>
		...
		<section id="corpo">
			<marquee><h1>Delete seu DvD e acesse-os quando quiser!</h1></marquee>
			
			<table class="opmenu">
				<tr>
                    <td><a href="deletar-dvd.php">Deletar DvD</a></td>
					<td><a href="cadastrar-dvds.php">Cadastrar DvDs</a></td>
...
<?php
    ...
    if(isset($_POST['btnenviar'])) {
        $idvd = $_POST['id'];
        $nome = $_POST['nome'];
        $sql = "DELETE FROM tb_dvd WHERE cd_dvd = '$idvd' OR nm_dvd = '$nome'";
